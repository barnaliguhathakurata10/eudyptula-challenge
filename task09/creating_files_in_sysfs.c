...
#define MY_ID "Debanjan Guha Thakurata\n"
#define MY_ID_LEN 24            
...
static int __init hello_init(void)
{
        ...
        printk(KERN_INFO "Creating the devices...\n");
...
{
        printk(KERN_INFO "Removing the devices...\n");
        kobject_put(hello_kobj);
}
...
MODULE_DESCRIPTION("Creating files in Sysfs module");
